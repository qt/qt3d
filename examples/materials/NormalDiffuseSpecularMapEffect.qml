            ...
            renderPasses: [
                RenderPass {
                    ...
                    bindings: [
                        ...
                        ParameterMapping { parameterName: "specular"; shaderVariableName: "specularTexure"; bindingType: ParameterMapping.Uniform },
                        ParameterMapping { parameterName: "normal";   shaderVariableName: "normalTexture";  bindingType: ParameterMapping.Uniform }
                    ]

                    shaderProgram: ShaderProgram {
                        vertexShaderCode:   loadSource("qrc:/shaders/normaldiffusespecularmap.vert")
                        fragmentShaderCode: loadSource("qrc:/shaders/normaldiffusespecularmap.frag")
                    }
                }
            ]
        }
