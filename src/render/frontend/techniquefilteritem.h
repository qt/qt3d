...
#ifndef QT3D_TECHNIQUEFILTERNODE_H
#define QT3D_TECHNIQUEFILTERNODE_H
...
class QT3DRENDERERSHARED_EXPORT TechniqueFilterNode : public Node, public TechniqueFilter
{
    Q_OBJECT
...
#endif // QT3D_TECHNIQUEFILTERNODE_H
