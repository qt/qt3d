...
#ifndef QT3D_RENDER_RENDERSCENEOBSERVER_H
#define QT3D_RENDER_RENDERSCENEOBSERVER_H
...
class RenderSceneObserver : public QSceneObserverInterface
{
public:
    RenderSceneObserver();
...
#endif // QT3D_RENDER_RENDERSCENEOBSERVER_H
