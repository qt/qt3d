...
#ifndef QT3DRENDER_RENDER_RHI_IMAGESUBMISSIONCONTEXT_P_H
#define QT3DRENDER_RENDER_RHI_IMAGESUBMISSIONCONTEXT_P_H
...
public:
    ...
    void endDrawing();
    int activateImage(ShaderImage *image, RHITexture *tex);
...
#endif // QT3DRENDER_RENDER_RHI_IMAGESUBMISSIONCONTEXT_P_H
