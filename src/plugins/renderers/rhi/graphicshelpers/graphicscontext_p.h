...
#ifndef QT3DRENDER_RENDER_RHI_GRAPHICSCONTEXT_H
#define QT3DRENDER_RENDER_RHI_GRAPHICSCONTEXT_H
...
public:
    ...
    void introspectShaderInterface(RHIShader *shader);
...
#endif // QT3DRENDER_RENDER_RHI_GRAPHICSCONTEXT_H
