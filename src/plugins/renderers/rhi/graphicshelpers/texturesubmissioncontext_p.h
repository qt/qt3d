...
#ifndef QT3DRENDER_RENDER_RHI_TEXTURESUBMISSIONCONTEXT_H
#define QT3DRENDER_RENDER_RHI_TEXTURESUBMISSIONCONTEXT_H
...
public:
    ...
    void endDrawing();
    int activateTexture(TextureScope scope, QOpenGLContext *gl, RHITexture* tex);
    void deactivateTexture(RHITexture *tex);
    void deactivateTexturesWithScope(TextureScope ts);

private:
    void decayTextureScores();
    int assignUnitForTexture(RHITexture* tex);
...
#endif // QT3DRENDER_RENDER_RHI_TEXTURESUBMISSIONCONTEXT_H
