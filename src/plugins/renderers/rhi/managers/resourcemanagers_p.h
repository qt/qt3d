...
#ifndef QT3DRENDER_RENDER_RHI_glresourcemanagers_p_H
#define QT3DRENDER_RENDER_RHI_glresourcemanagers_p_H
...
class Q_AUTOTEST_EXPORT RHIFenceManager : public QHash<Qt3DCore::QNodeId, RHIFence>
{
};

class Q_AUTOTEST_EXPORT VAOManager : public Qt3DCore::QResourceManager<
        RHIVertexArrayObject,
        VAOIdentifier,
...
public:
    ...
    inline RHIFenceManager *rhiFenceManager() const noexcept { return m_rhiFenceManager; }

private:
    RHIBufferManager *m_rhiBufferManager;
    RHIShaderManager *m_rhiShaderManager;
    RHITextureManager *m_rhiTextureManager;
    RHIFenceManager *m_rhiFenceManager;
...
Q_DECLARE_RESOURCE_INFO(Qt3DRender::Render::Rhi::RHIVertexArrayObject, Q_REQUIRES_CLEANUP)

QT_END_NAMESPACE

#endif // QT3DRENDER_RENDER_RHI_glresourcemanagers_p_H
