...
#include "qcuboidcollisionshape.h"
#include "qcuboidcollisionshape_p.h"
...
QCuboidCollisionShape::QCuboidCollisionShape(Qt3DCore::QNode *parent)
    : QAbstractCollisionShape(*new QCuboidCollisionShapePrivate, parent)
{
}

QCuboidCollisionShape::QCuboidCollisionShape(QCuboidCollisionShapePrivate &dd, Qt3DCore::QNode *parent)
    : QAbstractCollisionShape(dd, parent)
{
}

QCuboidCollisionShape::~QCuboidCollisionShape()
{
}
