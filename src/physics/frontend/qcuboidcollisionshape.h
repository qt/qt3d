...
#ifndef QT3DPHYSICS_QCUBOIDCOLLISIONSHAPE_H
#define QT3DPHYSICS_QCUBOIDCOLLISIONSHAPE_H

#include <Qt3DPhysics/qt3dphysics_global.h>
#include <Qt3DPhysics/qabstractcollisionshape.h>

QT_BEGIN_NAMESPACE

namespace Qt3DPhysics {

class QCuboidCollisionShapePrivate;
...
private:
    Q_DECLARE_PRIVATE(QCuboidCollisionShape)
...
#endif // QT3DPHYSICS_QCUBOIDCOLLISIONSHAPE_H
