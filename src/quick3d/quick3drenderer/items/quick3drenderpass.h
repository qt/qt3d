...
private:
    static void appendCriteria(QQmlListProperty<Qt3D::QRenderPassCriterion> *list, QRenderPassCriterion *criterion);
    static QRenderPassCriterion *criterionAt(QQmlListProperty<Qt3D::QRenderPassCriterion> *list, int index);
    static int criteriaCount(QQmlListProperty<Qt3D::QRenderPassCriterion> *list);
    static void clearCriteria(QQmlListProperty<Qt3D::QRenderPassCriterion> *list);
