...
class tst_ConductedClipAnimator: public Qt3DCore::QBackendNodeTester
{
    Q_OBJECT
...
private Q_SLOTS:
    ...
    {
        // GIVEN
        Qt3DAnimation::Animation::ConductedClipAnimator backendAnimator;
...
QTEST_APPLESS_MAIN(tst_ConductedClipAnimator)

#include "tst_conductedclipanimator.moc"
